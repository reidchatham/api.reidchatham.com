...
//        .package(url: "https://github.com/krzyzanowskim/CryptoSwift.git", from: "1.0.0"),
    ...
    targets: [
        .target(name: "App", dependencies: ["FluentMySQL", "FluentPostgreSQL", "Vapor", "Leaf", "Authentication", "Crypto", "JWT", "CryptoSwift", "SendGrid", "LingoVapor", "JWTDataProvider", "JWTVapor", "SkelpoMiddleware"]),
